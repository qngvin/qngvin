    ...
    <PageTransition className="h-full w-1/3 flex flex-col justify-center tracking-tight font-montserrat">  
      <p className='text-black dark:text-white font-bold text-[15px]'>
       ...
       <p className='text-black dark:text-white tracking-[-0.03em] text-[15px] mb-4'>
        ...
        {' / '}
        <a href={ContactType.GitHub} className="underline font-normal text-sm tracking-tight hover:text-gray-300" target="_blank" rel="noopener noreferrer">GitHub</a>
        {' / '}
        <a href={ContactType.Instagram} className="underline font-normal text-sm tracking-tight hover:text-gray-300" target="_blank" rel="noopener noreferrer">Instagram</a>
      </p>
    </PageTransition>
  )
}
