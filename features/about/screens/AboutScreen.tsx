  ...
  return (
    <PageTransition className="h-full w-1/3 flex flex-col justify-center tracking-tight font-montserrat">  
      ...
      <p className='text-white font-normal text-sm mb-5'>
        My strong suit is in Web Development, but right now I'm also learning a lot about AI and machine learning. I also experiment in algorithmic trading for FOREX and commodities in my spare time.
      </p>
